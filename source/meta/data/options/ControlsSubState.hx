...
class ControlsSubState extends MusicBeatSubstate {
	...
	public function new() {
      ...
      var isMobileKey:Bool = (optionShit[i][0] == mobileKey);
			...
			var optionText:Alphabet = new Alphabet(0, (10 * i), optionShit[i][0], (!isCentered || isDefaultKey (!ProgressionHandler.isRodent) || isMobileKey), false);
		...
		if (meta.states.desktop.DesktopOptionsState.instance != null) cameras = [meta.states.desktop.DesktopOptionsState.instance.camControls];
	}
