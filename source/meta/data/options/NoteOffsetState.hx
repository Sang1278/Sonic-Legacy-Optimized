...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		if(controls.BACK)
		{
			...
			if(ProgressionHandler.isRodent) MusicBeatState.switchState(new meta.data.options.OptionsState());
			else FlxG.switchState(new meta.states.desktop.DesktopOptionsState());
