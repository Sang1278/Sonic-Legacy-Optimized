...
function addPhase3() {
    ...
    addObject1('henges3','p2/bgFiles',1.65,[0.8,0.8],'xy',[-50+p3Offsets[0],-120+p3Offsets[1]],false,3,12);

    if (!ClientPrefs.data.lowQuality) {
        addObject1('Smoke1','p2/smoke',1.65,[0.7,0.7],'0',[-275,-150],false,3,24);

        addObject1('Smoke2','p2/smoke',1.65,[0.7,0.7],'0',[1000,-125],false,3,24);
    }
    ...
    ObjectTools.setScale(fireBG,1.65);
    fireBG.screenCenter();
    ...
    addObject1('pike1','p2/bgFiles',1.65,[0.9,0.9],'xy',[-610+p3Offsets[0],100+p3Offsets[1]],false,3,12);

    addObject1('pike2','p2/bgFiles',1.65,[0.9,0.9],'xy',[-210+p3Offsets[0],100+p3Offsets[1]],false,3,12);

    addObject1('pike3','p2/bgFiles',1.65,[0.9,0.9],'xy',[610+p3Offsets[0],0+p3Offsets[1]],false,3,12);

    addObject1('floor3','p2/bgFiles',1.65,[1,1],'xy',[-50+p3Offsets[0],200+p3Offsets[1]],false,3,12);

    addObject1('head','p2/bgFiles',1.65,[1,1],'xy',[-334+p3Offsets[0],535+p3Offsets[1]],true,3,12);

    addObject1('fgLEFT','p2/bgFiles',1.65,[1.25,1.25],'xy',[-1200+p3Offsets[0],700+p3Offsets[1]],true,3,12);

    addObject1('fgRIGHT','p2/bgFiles',1.65,[1.25,1.25],'xy',[1200+p3Offsets[0],600+p3Offsets[1]],true,3,12);
...
function addPhase2() {
    ...
    addObject1('mountains','p1/bgFiles',1.65,[0.5,0.425],'xy',[0,-100],false,2,12);

    addObject1('water','p1/bgFiles2',1.65,[0.5,0.5],'xy',[0,-95],false,2,12);
...
function addPhase1() {
    addObject('whatsupthesky',1.65,[0.4,0.4],'xy',[-100,0],false,1);

    addObject1('biggerbackrocks','bgFiles',1.65,[0.5,0.5],'xy',[0,0],false,1,12);
    
    addObject1('backrocks','bgFiles',1.65,[0.5,0.5],'xy',[-50,0],false,1,12);

    addObject1('agua','waterfall',1.65,[0.5,0.5],'xy',[0,0],false,1,12);

    addObject1('mmmpalms','bgFiles',1.65,[0.85,0.85],'xy',[0,0],false,1,12);

    addObject1('ground','bgFiles',1.65,[1,1],'x',[0,500],false,1,12);
